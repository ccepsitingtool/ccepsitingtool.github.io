	...
	_handleSubmit: function() {	//button and tooltip click and enter submit
		...
		else
		{
			...
			else
			{
				...
				{
					// DataKind - Michael Dowd code alteration to allow for closing a selected point. 
					if (clickKillIcon != undefined) { mainMap.removeLayer(clickKillIcon)}
					...
					clickKillIcon.addTo(mainMap).on('click', function (){
						searchControl._map.removeLayer(searchControl._markerSearch)
